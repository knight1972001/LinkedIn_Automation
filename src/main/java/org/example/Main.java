...
public class Main {
    ...
    public static void goToMyPage(Driver driver) {
        System.out.println("Go to My page");

        WebElement accountLogo = driver.getElementByXpath("//header/div[1]/nav[1]/ul[1]/li[6]/div[1]/button[1]/span[1]");
        driver.clickElement(accountLogo);

        WebElement viewProfile = driver.getElementByLinkName("View Profile");
        driver.clickElement(viewProfile);
    }
...
//            System.out.println(connectButton.getText() + " button detected.");
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.navigateTo("http://linkedin.com");
//        hideMessageBox(driver);
//        goToMyPage(driver);
//        peopleYouMayKnowExpandList(driver);
        applyJob(driver);
        Thread.sleep(10000);
//        driver.quit();
    }
